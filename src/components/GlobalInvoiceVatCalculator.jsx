...
import { FileText, CheckCircle2, ShieldCheck, Copy, Percent, Globe, Info } from 'lucide-react';
    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="text-center max-w-3xl mx-auto space-y-3">
        <div className="inline-flex items-center space-x-2 px-3 py-1 rounded-full bg-purple-500/10 border border-purple-500/20 text-purple-400 text-xs font-semibold">
          ...
          <span>Küresel Fatura & KDV / Sales Tax Matrah Motoru</span>
        </div>
        <h2 className="text-3xl sm:text-4xl font-extrabold text-white tracking-tight">
          Küresel Fatura ve KDV / Satış Vergisi Hesaplayıcı
        </h2>
        <p className="text-slate-400 text-sm leading-relaxed">
          B2B ve B2C uluslararası hizmet satışlarında KDV (VAT / GST / Sales Tax) oranlarını ve uluslararası ters ödeme yükümlülüğünü (Reverse Charge / %0 Export) hesaplayın.
        </p>
      </div>
      ...
      <div className="glass-card p-6 sm:p-8 rounded-3xl border-slate-800 space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="space-y-2">
            ...
            >
              <option value="netToGross">KDV'siz Tutar ➔ KDV Dahil (Net'ten Brüt'e)</option>
              <option value="grossToNet">KDV Dahil Tutar ➔ KDV Hariç (Brüt'ten Net'e)</option>
            </select>
          </div>

          <div className="space-y-2">
            <label className="text-xs font-bold text-slate-300 uppercase tracking-wider">
              Hedef Ülke / Vergi Rejimi
            </label>
            <select
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 bg-slate-900/60 p-4 rounded-2xl border border-slate-800">
          <label className="flex items-center space-x-3 cursor-pointer">
            ...
            />
            <span className="text-sm font-semibold text-slate-200">B2B Kurumsal Müşteri Faturası</span>
          </label>
          ...
          <label className="flex items-center space-x-3 cursor-pointer">
            <input 
              ...
              className="w-4 h-4 rounded border-slate-700 text-purple-600 focus:ring-purple-500 bg-slate-950"
            />
            <span className="text-sm font-semibold text-slate-200">Uluslararası Hizmet İhracatı (Reverse Charge / %0 KDV)</span>
          </label>
        </div>
        ...
        <div className="bg-slate-900/90 border border-slate-800 p-6 rounded-2xl space-y-6">
          <div className="flex items-center justify-between">
            <h3 className="text-sm font-bold text-white flex items-center space-x-2">
              ...
              <span>Fatura Dökümü ve Matrah Hesabı</span>
            </h3>
            <button 
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-slate-950/80 p-5 rounded-xl border border-slate-800">
              <span className="text-xs font-bold text-slate-400 uppercase tracking-wider">Matrah (Net Tutar)</span>
            ...
            <div className="bg-slate-950/80 p-5 rounded-xl border border-slate-800">
              <span className="text-xs font-bold text-slate-400 uppercase tracking-wider">
                Hesaplanan KDV (%{result.effectiveVatRatePercent})
              </span>
            ...
            <div className="bg-slate-950/80 p-5 rounded-xl border border-slate-800">
              <span className="text-xs font-bold text-slate-400 uppercase tracking-wider">Fatura Genel Toplamı (Brüt)</span>
          ...
          <div className="bg-purple-950/20 border border-purple-500/20 p-4 rounded-xl text-xs text-purple-300 flex items-start space-x-2">
            ...
            <span><strong>Fatura Notu:</strong> {result.invoiceNote}</span>
          </div>
        </div>
