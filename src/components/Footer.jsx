...
export default function Footer({ lang = 'en' }) {
  ...
  return (
    <footer className={`border-t border-slate-800/80 bg-slate-950 transition-all duration-300 ${isMobile ? 'mt-10 py-6 px-4' : 'mt-20 py-12 px-4 lg:px-8'}`}>
      ...
      <div className="max-w-7xl mx-auto mt-6 text-[10px] text-slate-800/40 leading-relaxed text-justify">
