...
import { g as generateUnifiedSchema, i as injectJsonLdSchema } from "./schemaGenerator-F7liX1lB.js";
import { HelpCircle, ChevronUp, ChevronDown, Lock, RefreshCw, Star } from "lucide-react";
...
function ProgrammaticSeoGrid({ lang = "en" }) {
  ...
  return /* @__PURE__ */ jsx("div", { className: "space-y-8 max-w-4xl mx-auto my-12", children: /* @__PURE__ */ jsxs("div", { className: "glass-card p-6 sm:p-8 rounded-3xl border-slate-800 space-y-6", children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "space-y-3", children: activeFaqs.map((faq, idx) => {
        ...
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxs("div", { className: "p-4 sm:p-5 flex items-center justify-between gap-4 select-none", children: [
              /* @__PURE__ */ jsx("span", { className: "text-xs sm:text-sm font-bold text-white", children: faq.question }),
            ...
            isOpen && /* @__PURE__ */ jsx("div", { className: "px-4 sm:px-5 pb-5 pt-1 text-xs text-slate-300 leading-relaxed border-t border-slate-800/50 animate-float", children: faq.answer })
          ]
        },
        idx
      );
...
export {
  ProgrammaticSeoGrid as default
};
