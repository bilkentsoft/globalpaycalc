...
function AnalyticsTab({ googleStats }) {
  ...
  const data = isDataReady ? googleStats : { geoData: [], devices: [], gscQueries: [] };
  const calculators = [
  ...
  return /* @__PURE__ */ jsxs("div", { className: "space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "glass-card p-4 sm:p-6 rounded-2xl border-purple-500/20", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxs("table", { className: "w-full text-left border-collapse", children: [
        ...
        /* @__PURE__ */ jsx("tbody", { children: !isDataReady || !data.gscQueries || data.gscQueries.length === 0 ? /* @__PURE__ */ jsx("tr", { children: /* @__PURE__ */ jsx("td", { colSpan: "4", className: "py-8 text-center text-sm font-bold text-purple-300", children: "Google Search Console API bağlandığında gerçek organik kelimeleriniz burada listelenecektir." }) }) : data.gscQueries.map((q, idx) => /* @__PURE__ */ jsxs("tr", { className: "border-b border-purple-500/10 hover:bg-purple-900/20 transition", children: [
