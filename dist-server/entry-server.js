...
import { useNavigate, Link, useParams, useLocation, Routes, Route } from "react-router-dom";
import { Calculator, X, Lock, FileText, Heart, Compass, Home, Loader, Globe, DollarSign, Download, Code, Sparkles, Zap, UploadCloud, ShieldCheck, RefreshCw, PieChart, Briefcase, Info, ArrowRightLeft, Clock, TrendingDown, Award, Cpu, Building2, CheckCircle2, XCircle, HelpCircle, ChevronUp, ChevronDown, Star, ArrowLeftRight, TrendingUp, ShieldAlert, Link as Link$1, Cookie, UserCheck, Image as Image$1 } from "lucide-react";
...
function ToolSeoArticle({ activeTool = "take-home", lang = "en" }) {
  ...
  return /* @__PURE__ */ jsxs("article", { className: "glass-card rounded-2xl border-slate-800 mt-8 p-6 sm:p-10 space-y-8", children: [
    /* @__PURE__ */ jsxs("header", { className: "space-y-2 border-b border-slate-800 pb-6", children: [
      /* @__PURE__ */ jsxs("h2", { className: "text-2xl font-bold text-white flex items-center space-x-3", children: [
        /* @__PURE__ */ jsx(Info, { className: "w-6 h-6 text-brand-400 flex-shrink-0" }),
...
function ContentWrapper({ lang, t }) {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    activeTab !== "admin" && !location.pathname.includes("/calculator/") && !location.pathname.includes("/tools/") && /* @__PURE__ */ jsxs("div", { className: "text-center max-w-4xl mx-auto space-y-6 pt-4", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "hidden md:flex flex-wrap justify-center gap-2 pt-4", children: tools.map((tool) => {
      ...
      /* @__PURE__ */ jsxs("div", { className: "md:hidden block space-y-4 pt-4", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex space-x-1 bg-slate-900/60 p-1.5 rounded-2xl border border-slate-850/80 max-w-md mx-auto", children: [
          /* @__PURE__ */ jsxs(
            "button",
            {
        ...
        /* @__PURE__ */ jsx("div", { className: "grid grid-cols-2 gap-3 pt-2", children: tools.filter((t2) => t2.cat === activeCat).map((tool) => {
          const Icon = tool.icon;
          const isActive = activeTab === tool.path.replace("/", "") || tool.path === "/take-home" && activeTab === "video";
          const borderColors = {
