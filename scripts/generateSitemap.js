...
const staticRoutes = ['', '/take-home', '/contractor', '/hourly-rate', '/beckham-law', '/crypto-tax', '/eor-cost', '/nomad-visa', '/salary', '/inflation', '/fx-fees', '/vat', '/timezone', '/wasm', '/ai', '/privacy', '/terms', '/about', '/contact'];
